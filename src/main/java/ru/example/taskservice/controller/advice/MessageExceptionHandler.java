...
public class MessageExceptionHandler {
          ...
          public ResponseEntity<ErrorResponse> handlePermanentFailure(MessagePermanentFailureException ex) {
          ...
          public ResponseEntity<ErrorResponse> handleSerializationError(MessageSerializationException ex) {
